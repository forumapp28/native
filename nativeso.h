...
namespace SCRIPT
{
	...
	static void TRIGGER_SCRIPT_EVENT(BOOL p0, int* argsStruct, int argStructSize, int bitset) { invoke<Void>(0x5AE99C571D5BBE5D, p0, argsStruct, argStructSize, bitset); } // 0x5AE99C571D5BBE5D 0x54763B35
